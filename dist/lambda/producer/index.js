...
var require_lucide_react = __commonJS({
  "node_modules/lucide-react/dist/cjs/lucide-react.js"(exports2) {
    ...
    var BadgeCheck2 = createLucideIcon("BadgeCheck", [
      [
        "path",
        {
          d: "M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z",
    ...
    var HeartPulse2 = createLucideIcon("HeartPulse", [
      [
        "path",
        {
          d: "M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z",
    ...
    var LifeBuoy2 = createLucideIcon("LifeBuoy", [
      ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ...
    var UserCog2 = createLucideIcon("UserCog", [
    ...
    exports2.HeartPulse = HeartPulse2;
    exports2.HeartPulseIcon = HeartPulse2;
    ...
    exports2.LifeBuoy = LifeBuoy2;
    exports2.LifeBuoyIcon = LifeBuoy2;
    ...
    exports2.LucideHeartPulse = HeartPulse2;
    ...
    exports2.LucideLifeBuoy = LifeBuoy2;
    ...
    exports2.LucideUserCog = UserCog2;
...
// lambda/server-only-stub.js
var require_server_only_stub = __commonJS({
  "lambda/server-only-stub.js"(exports2, module2) {
    "use strict";
    module2.exports = {};
  }
});
...
var work_item_producer_exports = {};
__export(work_item_producer_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(work_item_producer_exports);

// lib/work/work-type.ts
var import_lucide_react = __toESM(require_lucide_react());
var WORK_TYPE_META = {
  VERIFY_IDENTITY: {
    label: "Verify identity",
    domain: "IDENTITY",
    icon: import_lucide_react.BadgeCheck,
  ...
  COMPLETE_PROFILE: {
    ...
    domain: "READINESS",
    icon: import_lucide_react.UserCog,
    defaultPriority: "LOW",
  ...
  ADD_EMERGENCY_INFO: {
    ...
    domain: "READINESS",
    icon: import_lucide_react.HeartPulse,
  ...
  ADD_EMERGENCY_CONTACT: {
    ...
    domain: "READINESS",
    icon: import_lucide_react.Phone,
    defaultPriority: "LOW",
...
function workTypeMeta(type) {
  return WORK_TYPE_META[type];
}

// lib/work/rules.ts
var FACTOR_WORK_TYPE = {
...
function dueDateFor(createdAt, priority) {
  return addDays(createdAt, dueOffsetDays(priority));
}

// lib/data/aws/keys.ts
var PROFILE_SK = "PROFILE";
var IDENTITY_SK = "IDENTITY";
var EMERGENCY_SK = "EMERGENCY";
var DOCUMENT_BY_PROFILE_PREFIX_SK = "DOCUMENT#";
var GSI2_INDEX = "GSI2";
var AUDIT_PK_PREFIX = "AUDIT#";
var AUDIT_TYPE = "AUDIT_EVENT";
var profilePk = (profileId) => `PROFILE#${profileId}`;
var documentSk = (documentId) => `${DOCUMENT_BY_PROFILE_PREFIX_SK}${documentId}`;
var auditPk = (targetType, targetId) => `${AUDIT_PK_PREFIX}${targetType}#${targetId}`;
var auditSk = (timestamp, eventId) => `TS#${timestamp}#${eventId}`;
var auditProfileGsiPk = (profileId) => `PROFILE#${profileId}`;
...
function itemToEmergencyProfile(item) {
  const e = item;
  return {
    profileId: String(e.profileId),
    bloodType: e.bloodType,
    allergies: e.allergies,
    chronicConditions: e.chronicConditions,
    medications: e.medications,
    disabilities: e.disabilities,
    emergencyInstructions: e.emergencyInstructions,
    emergencyContacts: e.emergencyContacts,
    medicalAid: e.medicalAid,
    preferredHospital: e.preferredHospital,
    familyDoctor: e.familyDoctor,
    updatedAt: String(e.updatedAt)
  };
}
function itemToIdentity(item) {
  return {
    profileId: String(item.profileId),
...
var DEVICE_SK = "DEVICE";
var DEVICE_BY_PROFILE_PREFIX = "DEVICE#";
var GSI1_INDEX = "GSI1";
var devicePk = (deviceId) => `DEVICE#${deviceId}`;
var tokenGsiPk = (token) => `TOKEN#${token}`;
var deviceSkByProfile = (deviceId) => `${DEVICE_BY_PROFILE_PREFIX}${deviceId}`;
...
function deviceByProfileItem(device) {
  return {
...
var WORK_BY_CUSTOMER_PREFIX = "WORK#";
var workPk = (domain) => `WORK#${domain}`;
var workQueueSk = (status, priority, dueAt, workItemId) => `STATUS#${status}#PRIORITY#${priority}#DUE#${dueAt}#WORK#${workItemId}`;
var workCustomerSk = (status, workItemId) => `${WORK_BY_CUSTOMER_PREFIX}${status}#${workItemId}`;
function workQueueItem(record) {
  return {
...
function workCustomerItem(record) {
  return {
...
function itemToWorkRecord(item) {
  return {
...
var AGGREGATE_PROTECTED_LIVES_PK = "AGGREGATE#PROTECTED_LIVES";
var AGGREGATE_CURRENT_SK = "CURRENT";
function itemToProtectedLivesAggregate(item) {
  return {
...
function workIntentForChange(change) {
  ...
  if (change.keys.SK === PROFILE_SK) {
    const status = str2(img.identityVerificationStatus);
    const previous = str2(change.oldImage?.identityVerificationStatus);
...
function unmarshallValue(av) {
  ...
  if ("M" in v) return unmarshallImage(v.M);
  if ("L" in v) return v.L.map(unmarshallValue);
  if ("SS" in v) return v.SS;
  if ("NS" in v) return v.NS.map((n) => Number(n));
  return v;
}
...
var EVENT_NAMES = /* @__PURE__ */ new Set(["INSERT", "MODIFY", "REMOVE"]);
function parseStreamRecord(record) {
  ...
  const eventName = EVENT_NAMES.has(r.eventName ?? "") ? r.eventName : "MODIFY";
  return {
    eventName,
    keys: { PK: pk, SK: sk },
...
var NO_PROTECTION_CHANGE = {
  protected: 0,
  inProgress: 0
};
function protectedLivesDelta(before, after) {
  ...
  return NO_PROTECTION_CHANGE;
}
function crossesProtectedBoundary(delta) {
...
var newAuditId = () => crypto.randomUUID();
...
var awsRegion = env("APP_AWS_REGION") ?? env("AWS_REGION") ?? "eu-west-1";
var appEnv = env("APP_ENV") ?? "development";
var isProduction = appEnv === "production" || process.env.NODE_ENV === "production";
var mockDefault = !isProduction;
var config = {
   ...
   */
  patientAppUrl: normalize(process.env.NEXT_PUBLIC_PATIENT_APP_URL) ?? normalize(process.env.NEXT_PUBLIC_APP_URL) ?? "http://localhost:3000",
  appEnv,
  isProduction,
  awsRegion,
...
// lib/work/generate.ts
var BASE_CREATED = "2026-06-26T09:00:00.000Z";
var TYPE_OWNER = {
  VERIFY_IDENTITY: "Lerato Nkosi",
  ISSUE_CARD: "Pieter van Wyk",
  APPROVE_PRACTITIONER: "Naledi Khumalo"
};
function assignment(type, leaveOpen) {
  if (leaveOpen) return { assigneeName: null };
  const name = TYPE_OWNER[type];
  return name ? { assigneeName: name, assignedAt: BASE_CREATED } : { assigneeName: null };
}
function statusFor(type, customer) {
...
function stepFor(type, customer) {
  if (type === "ISSUE_CARD" && customer.cardStatus === "PENDING") return 1;
  return 0;
}
function generateReadinessWork(customer) {
  const unprotected = protectionStatus(customer) === "UNPROTECTED";
  return customerReadinessFactors(customer).filter((factor) => !factor.met).map((factor, i) => {
...
function generateAllWork(customers) {
  return [...customers.flatMap(generateReadinessWork), ...manualWork()];
}

// lib/work/record.ts
function workItemToRecord(w) {
  return {
    workItemId: w.id,
...
function customerToProfile(c) {
  ...
  return {
    ...
    status: "ACTIVE",
    verificationLevel: c.identityStatus === "VERIFIED" ? "IDENTITY_VERIFIED" : "UNVERIFIED",
    idType: submitted ? "SOUTH_AFRICAN_ID" : void 0,
    idNumberMasked: submitted ? "9001\u2022\u2022\u2022\u2022\u2022\u2022\u202200" : void 0,
    identityVerificationStatus: IDENTITY_STATUS[c.identityStatus],
    identitySubmittedAt: submitted ? "2026-06-28T08:00:00.000Z" : void 0,
    identityVerifiedAt: c.identityStatus === "VERIFIED" ? "2026-05-01T09:00:00.000Z" : void 0,
    createdAt: c.joinedAt,
    updatedAt: c.joinedAt
  };
}
function seedWorkItems() {
  return generateAllWork(MOCK_CUSTOMERS).filter((w) => Boolean(w.customerId)).map(workItemToRecord);
}
    ...
    return [
      {
        ...
        activationCode: status === "PENDING" ? `ACT-${c.id.slice(-4)}` : void 0,
        issuedAt: c.joinedAt,
        activatedAt: status === "ACTIVE" ? c.joinedAt : void 0,
        updatedAt: c.joinedAt
      }
    ];
  });
}
function seedTapTestAudit() {
  return [
    {
...
function customerToEmergency(c) {
  if (!c.emergencyInfoComplete && c.emergencyContactsCount === 0) return null;
  const e = { profileId: c.id, updatedAt: c.joinedAt };
...
var mockStore = globalForStore.__emridOpsMockStore ?? (globalForStore.__emridOpsMockStore = freshStore());

// lib/data/mock/profile-repository.ts
var MockProfileRepository = class {
  ...
  async setIdentityDecision(profileId, input) {
    ...
    const updated = {
      ...
      verificationLevel: input.decision === "VERIFIED" ? "IDENTITY_VERIFIED" : current.verificationLevel,
...
// lib/data/mock/document-repository.ts
var MockDocumentRepository = class {
  async listForProfile(profileId) {
    return (mockStore.documents.get(profileId) ?? []).map((d) => ({ ...d }));
  }
  async getDocument(profileId, documentId) {
...
// lib/data/mock/audit-repository.ts
var MockAuditRepository = class {
  async record(event) {
    const recorded = {
      ...event,
      eventId: newAuditId(),
  ...
  async listForProfile(profileId) {
    return mockStore.audit.filter((e) => auditEventProfileId(e) === profileId).slice().reverse();
  }
  async listForTarget(targetType, targetId) {
    return mockStore.audit.filter((e) => e.targetType === targetType && e.targetId === targetId).slice().reverse();
  }
};

// lib/data/mock/work-repository.ts
var MockWorkItemRepository = class {
  async create(record) {
  ...
  async listByDomain(domain) {
    return [...mockStore.workItems.values()].filter((w) => w.workDomain === domain).map((w) => ({ ...w }));
  }
  async listForCustomer(customerId) {
    return [...mockStore.workItems.values()].filter((w) => w.customerId === customerId).map((w) => ({ ...w }));
  }
  async transition(current, input) {
...
var MockDeviceRepository = class {
  async listForCustomer(customerId) {
    return [...mockStore.devices.values()].filter((d) => d.profileId === customerId).map((d) => ({ ...d }));
  }
  ...
  async markCardActive(customerId) {
    ...
    const device = existing ? { ...existing, status: "ACTIVE", activatedAt: ts, updatedAt: ts } : {
...
// lib/data/mock/emergency-profile-repository.ts
var MockEmergencyProfileRepository = class {
  async getEmergencyProfile(profileId) {
    const e = mockStore.emergencyProfiles.get(profileId);
    return e ? { ...e } : null;
  }
};

// lib/data/mock/aggregate-repository.ts
var MockAggregateRepository = class {
  async getProtectedLives() {
    return { ...mockStore.protectedLives };
  }
  async adjustProtectedLives(delta) {
...
// lib/data/aws/client.ts
var import_server_only = __toESM(require_server_only_stub());
var import_client_dynamodb = require("@aws-sdk/client-dynamodb");
var import_lib_dynamodb = require("@aws-sdk/lib-dynamodb");
var docClient = null;
function getDocClient() {
  if (!docClient) {
    const base = new import_client_dynamodb.DynamoDBClient({ region: config.awsRegion });
    docClient = import_lib_dynamodb.DynamoDBDocumentClient.from(base, {
...
// lib/data/aws/profile-repository.ts
var DynamoProfileRepository = class {
   ...
   */
  async listByIdentityStatus(_status) {
    throw new Error(
      "listByIdentityStatus is not supported on the shared table without an access-pattern decision (GSI on identity status, or an Ops work index). See OPERATOR_HANDOFF.md \u2014 resolve before enabling real data for the Identity queue."
    );
  }
  async setIdentityDecision(profileId, input) {
    const { doc, table } = this.deps();
...
// lib/data/aws/document-repository.ts
var import_server_only3 = __toESM(require_server_only_stub());
var import_lib_dynamodb3 = require("@aws-sdk/lib-dynamodb");
var DynamoDocumentRepository = class {
  constructor(injected) {
    this.injected = injected;
  }
  deps() {
...
// lib/data/aws/audit-repository.ts
var import_server_only4 = __toESM(require_server_only_stub());
var import_lib_dynamodb4 = require("@aws-sdk/lib-dynamodb");
var DynamoAuditRepository = class {
  constructor(injected) {
    this.injected = injected;
  }
  deps() {
...
// lib/data/aws/work-repository.ts
var import_server_only5 = __toESM(require_server_only_stub());
var import_lib_dynamodb5 = require("@aws-sdk/lib-dynamodb");
var DynamoWorkItemRepository = class {
  constructor(injected) {
    this.injected = injected;
  }
  deps() {
...
// lib/data/aws/device-repository.ts
var import_server_only6 = __toESM(require_server_only_stub());
var import_lib_dynamodb6 = require("@aws-sdk/lib-dynamodb");
var DynamoDeviceRepository = class {
  constructor(injected) {
    this.injected = injected;
  }
  deps() {
...
// lib/data/aws/emergency-profile-repository.ts
var import_server_only7 = __toESM(require_server_only_stub());
var import_lib_dynamodb7 = require("@aws-sdk/lib-dynamodb");
var DynamoEmergencyProfileRepository = class {
  constructor(injected) {
    this.injected = injected;
  }
  deps() {
...
// lib/data/aws/aggregate-repository.ts
var import_server_only8 = __toESM(require_server_only_stub());
...
var DynamoAggregateRepository = class {
  constructor(injected) {
    this.injected = injected;
  }
  deps() {
  ...
  async adjustProtectedLives(delta) {
    ...
    const result = await doc.send(
      new import_lib_dynamodb8.UpdateCommand({
        TableName: table,
        Key: { PK: AGGREGATE_PROTECTED_LIVES_PK, SK: AGGREGATE_CURRENT_SK },
        UpdateExpression: "SET lastUpdatedAt = :ts, #t = :type ADD protectedCount :p, inProgressCount :ip, version :one",
    ...
    return result.Attributes ? itemToProtectedLivesAggregate(result.Attributes) : EMPTY;
  }
};
...
var mockProfile = new MockProfileRepository();
var mockDocument = new MockDocumentRepository();
var mockAudit = new MockAuditRepository();
var mockWork = new MockWorkItemRepository();
...
var awsWork = new DynamoWorkItemRepository();
